# About this Cool Concise Jekyll Blog Theme 馃馃馃
...
**[涓枃鐗?Chinese README 璇风偣鍑昏繖閲?馃嚚馃嚦](https://github.com/Gaohaoyang/gaohaoyang.github.io/blob/master/README-zh-cn.md)**
...
This theme supports both [disqus](https://disqus.com/) and [澶氳璇勮 duoshuo comments](http://duoshuo.com/). It's very easy to config your comments module.
...
This theme supports Google Analytics and Baidu Statistics锛?you can just config the id in the file `_config.yml`, as follows.

```yml
# statistic analysis 缁熻浠ｇ爜
# 鐧惧害缁熻 id锛屽皢缁熻浠ｇ爜鏇挎崲涓鸿嚜宸辩殑鐧惧害缁熻id锛屽嵆
# hm.src = "//hm.baidu.com/hm.js?xxxxxxxxxxxx";
# xxxxx瀛楃涓?baidu_tongji_id: xxxxxxxxxxxx
google_analytics_id: UA-xxxxxxxx # google 鍒嗘瀽杩借釜id
```
...
description_footer: 鏈珯璁板綍鎴戝墠绔箣鏃呯殑娌块€旈鏅紒
```
...
Get Google Analytics id or Baidu Statistics id锛?
...
# 鐧惧害缁熻 id锛屽皢缁熻浠ｇ爜鏇挎崲涓鸿嚜宸辩殑鐧惧害缁熻id锛屽嵆
# hm.src = "//hm.baidu.com/hm.js?xxxxxxxxxxxx";
# xxxxx瀛楃涓?baidu_tongji_id: cf850xxxxxxxxxxxxxxxx
google_analytics_id: UA-7xxxxxx-4 # google 鍒嗘瀽杩借釜id
```
...
You can write posts at folder `_posts`. At the beginning of the post, you should declare layout銆乼itle銆乨ate銆乧ategories銆乼ags銆乤uthor(optional) info銆乵athjax(optional锛宑lick [here](https://www.mathjax.org/) for more detail about `Mathjax`).

```
---
layout: post
title:  "瀵硅繖涓?jekyll 鍗氬涓婚鐨勬敼鐗堝拰閲嶆瀯"
date:   2016-03-12 11:40:18 +0800
categories: jekyll
tags: jekyll 绔彛 markdown Foxit RubyGems HTML CSS
author: Haoyang Gao
mathjax: true
---
```
...
* 2017.07.02 received Wechat user 楼9.99
* 2017.06.20 received Wechat user 楼2.22
* 2017.06.19 received Wechat user 楼6.66
* 2017.05.25 received Wechat user 楼1.00
* 2017.05.19 received 椋庝箣绛?楼6.66
* 2017.05.16 received 寮犻┌ 楼6.00
* 2017.05.03 received 甯屾垚 楼6.66
* 2017.04.24 received deezer 楼10.00
* 2017.04.13 received Abraham Xiao 楼30.00
* 2017.04.11 received Wechat user 楼4.00
* 2017.04.01 received Elvin Zeng 楼6.66
* 2017.03.13 received Wechat user 楼6.66
* 2017.03.04 received 鍙茶幈濮?楼9.90
* 2017.03.02 received 姊︽兂灏忕唺 楼6.66
* 2017.02.27 received 澶忓弸鏉?楼6.66
* 2017.02.26 received 鍏扮紭灏忓 楼10.00
* 2017.02.25 received Wechat user 楼6.66
* 2017.02.22 received Wechat user 楼6.66
* 2017.02.15 received Wechat user 楼10.00
* 2017.02.06 received Light 楼10.24
* 2017.01.15 received Wechat user 楼6.66
* 2016.12.17 received HitNoah 楼12.00
* 2016.12.09 received 鎯呰瀺 楼6.60
* 2016.11.25 received Wechat user 楼6.66
* 2016.11.16 received Wechat user 楼1.00
* 2016.10.24 received 濂囧嘲 楼6.66
* 2016.10.21 received 鏃环 楼10.00
* 2016.09.25 received 閼?楼6.66
* 2016.08.25 received Erlend Aakre $2.50
* 2016.08.10 received Wechat user 楼4.40
* 2016.07.25 received 閭撶偝鍒?楼6.66
* 2016.07.11 received 褰﹂ 楼6.66
* 2016.07.07 received Klci 楼2.50
* 2016.05.08 received 1057 楼10.57
* 2016.05.07 received 鍚存灄 楼2
* 2016.04.29 received 鍖楀綊 楼10
* 2016.04.28 received 榄忔闃砡Brian 楼2
* 2016.04.28 received 钖涘浆 楼8.8
...
* `[+]` Add `favicon.ico`
* `[^]` Fix bug at contents
* `[^]` Change the content scroll bar CSS style锛圤nly for `webkit` browser kernel锛?* `[^]` Change tag a color at demo page
